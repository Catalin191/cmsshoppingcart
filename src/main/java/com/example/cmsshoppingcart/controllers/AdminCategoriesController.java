...
public class AdminCategoriesController {
    ...
    // using this method, Thymeleaf, sees better the "category" model
...
//    }
    ...
    public String add(@Valid Category category, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model){
        ...
        if (categoryExists != null){
            ...
            redirectAttributes.addFlashAttribute("categoryInfo", category); //keep what you wrote in the field even if you have an error; along with the line 24 from add.html
